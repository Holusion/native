...
import {Button, connectStyle} from 'native-base'
import {StyleSheet, Text} from 'react-native'

import * as Config from '../../Config'

export function RetryButtonComponent(props) {
    return (
...
export default connectStyle('holusion.RetryButtonComponent', styles)(RetryButtonComponent)